...
add_action('unity/loaded', function ($container) {
    try {
        ...
        // Clear the member and meeting caches whenever one of those posts
        // changes, however it changed. A no-op for either unless the
        // container handed back Unity's caching repository, which it only
        // does when an object cache is present.
        \TsmlForUnity\Plugin::registerCacheInvalidators($container);
